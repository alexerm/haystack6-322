...
| page | what it is |
|---|---|
| [`route-guide.html`](route-guide.html) | a solver's 321 as a drivable route sheet: 223 teleports, each row saying where the gate is relative to your car. It is **not** the finished route |
...
JSON** — anything from [`../routes/`](../routes) or your own. Load
`finish-322-kattz95.json` to see the finished route.
